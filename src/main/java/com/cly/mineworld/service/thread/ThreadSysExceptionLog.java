...
public class ThreadSysExceptionLog implements Runnable {

	private String jsonStr;
	public ThreadSysExceptionLog(String jsonStr) {
	...
	private void sendLog(String sendStr) {
	    ...
	    producer.start();
        //Message msg = new Message("eva-sys-exception-log-topic","TagA",sendStr.getBytes());
        Message msg = new Message("eva-work-sys-exception-log-topic","TagA",sendStr.getBytes());//生产
